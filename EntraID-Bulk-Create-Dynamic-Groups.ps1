...
$Path = "C:\Users\MRomanowicz\OneDrive - ACCO Brands Corporation\Scripts\a365junkie\EntraID-Bulk-Create-Dynamic-Groups\EntraID-Bulk-Create-Dynamic-Groups.txt"
